  ...
  return (
    <div className='max-w-5xl mx-auto flex flex-col items-center justify-center gap-10'>
      ...
      <p className='text-lg text-center'>
        ...
        . Dungeons & Dragons is a fantasy tabletop role-playing game originally
        created and designed by Gary Gygax and Dave Arneson. The game was first
        published in 1974 by Tactical Studies Rules, Inc.
      </p>
